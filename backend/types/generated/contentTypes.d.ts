...
export interface ApiMemberMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    componentRolesArr: Attribute.Component<'roles.roles-test', true>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::member.member',
      'oneToOne',
    ...
    memberDisplayStatus: Attribute.Enumeration<
      [
        'Current Member',
    ...
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Current Member'>;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    blurb: Attribute.RichText & Attribute.Required;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::project.project',
      'oneToOne',
    ...
    > &
      Attribute.Private;
    hostedProjectURL: Attribute.String;
    image: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    imageAltText: Attribute.String;
    isCurrentProject: Attribute.Boolean & Attribute.Required;
