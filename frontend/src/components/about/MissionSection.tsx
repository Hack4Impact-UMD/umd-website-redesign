import missionCornerEnd from '@/components/assets/about/mission-corner-end.svg?url';
import missionCornerStart from '@/components/assets/about/mission-corner-start.svg?url';
