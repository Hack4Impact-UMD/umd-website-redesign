  ...
  return (
    <Faq>
      <FaqRow
        ...
        answer={
          <p>
            ...
            volunteer tracking forms, member directories, and data tracking softwares. Check out our projects page to
            see some of our previous work, and feel free to contact us with any project ideas!{' '}
          </p>
        }
      />
      <FaqRow
        ...
        answer={
          <p>
            These projects are free or low cost (around $5 to $15 per month) for the website and hosting expenses. We
            are building software to better help you serve your community, and we know how tight money can be so we try
            to keep these expenses as low as possible.
          </p>
        }
      />
      <FaqRow
        ...
        answer={
          <p>
            Most development begins at the start of the academic semseter and continues until around the end of the
            semester. Throughout all of this, we will remain in constant contact with you to ensure that we are building
            an application that you will want to use.
          </p>
        }
      />
      <FaqRow
        ...
        answer={
          <p>
            We strongly believe in continuous and transparent communication to ensure that your project is something
            that you will be happy with. This means we will be asking for constant feedback throughout the development
            cycle.
          </p>
        }
      />
      <FaqRow
        ...
        answer={
          <p>
            Once we hand the product off to you around the end of the academic semester, we want to give you time to
            experiment with it and find anything that needs to be changed. <br /> <br />
            Once we end the semester, we will no longer be able to make additions as easily due to limited resources on
            our end. If you encounter bugs on the site, we will attempt to correct these issues, but cannot guarantee
